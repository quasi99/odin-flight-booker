...
ActiveRecord::Base.transaction do
  ...
  ActiveRecord::Base.connection.reset_sequence!('bookings')
  ActiveRecord::Base.connection.reset_sequence!('passengers')
  ActiveRecord::Base.connection.reset_sequence!('flights')
  ActiveRecord::Base.connection.reset_sequence!('airports')
